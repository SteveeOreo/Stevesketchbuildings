...
const Footer = () => {
  ...
  return (
    <footer
      className={`fixed bottom-0 left-0 right-0 z-30 border-t border-stone-700 bg-accent-dark py-3 text-sm text-white transition-transform duration-300 ease-out ${
