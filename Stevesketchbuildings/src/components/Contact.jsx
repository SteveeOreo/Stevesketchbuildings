      ...
      <div className="grid gap-10 md:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] items-start">
        <div>
          ...
          <dl className="mt-6 space-y-3 text-sm text-slate-300">
            <div>
              <dt className="font-semibold text-base text-slate-200">Email</dt>
              <dd className="mt-1 text-slate-400">
                Chukwusteve1@gmail.com
              </dd>
            </div>
            <div>
              <dt className="font-semibold text-base text-slate-200">
                Phone <span className="font-normal text-slate-500">(optional)</span>
              </dt>
              <dd className="mt-1 text-slate-400">07025389146</dd>
            </div>
          </dl>
        </div>
